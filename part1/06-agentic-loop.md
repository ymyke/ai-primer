...
```
Behind the scenes — the conversation grows with each loop: MN should this line be outside the code block?

Step 1:  [..., user: "Find an Italian restaurant near my office..."]
             → tool_call: lookup_address("my office") MN should this be lookup_memory instead?
...
MN should we mention openclaw here (or elsewhere?) what are the interesting things to say about openclaw? is it the same as claude code, cursor etc.?